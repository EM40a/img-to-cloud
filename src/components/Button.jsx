    ...
    <div className="w-full">
      <div className="flex items-center">
        <button
          name="submit"
          type="submit"
          aria-label="Generate link button"
        ...
        <label
          ...
          className={`w-full truncate bg-gray-50 border border-e-0 border-gray-300 text-gray-500 dark:text-gray-300 text-sm border-s-0 focus:ring-blue-500 focus:border-blue-500 block p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:focus:ring-blue-500 dark:focus:border-blue-500 ${
